    ...
    if mode == "inverse":
        ...
        for param_name in inverse_params:
            ...
            if param_data is not None:
                ...
                all_metrics[f"{param_name}_estimated"] = float(
                    param_data["param_values"][-1]
                )
                ...
                if "true_value" in param_data and param_data["true_value"] is not None:
                    ...
                    all_metrics[f"{param_name}_error_percent"] = (
                        abs(est_val - true_val) / true_val * 100
                    )
...
def main():
    ...
    parser.add_argument(
        "--k-step", type=int, default=None, help="Optional k-step ahead evaluation"
    )
