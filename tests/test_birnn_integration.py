#!/usr/bin/env python3
"""Quick integration test for BI-RNN."""
...
def test_birnn_integration():
    """Test that BI-RNN integrates with Phase 1 data layer."""
    
    print("="*80)
    print("BI-RNN INTEGRATION TEST")
    print("="*80)
    ...
    try:
        ...
        print(f"   Scaling factors: m_t={data_window.m_t:.1f}, m_g={data_window.m_g:.1f}, "
    ...
    print("="*80)
    print("\nThe BI-RNN successfully:")
    print("  ✓ Loaded configuration")
    print("  ✓ Loaded Phase 1 data")
    print("  ✓ Built the GRU architecture")
    print("  ✓ Compiled with TensorFlow 2.x")
    print("  ✓ Ran training loop with biological residual")
    print("  ✓ Evaluated on test data")
    print("\n✨ BI-RNN is ready to train!")
    
    return True


if __name__ == "__main__":
    success = test_birnn_integration()
