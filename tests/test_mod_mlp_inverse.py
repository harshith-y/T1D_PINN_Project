#!/usr/bin/env python3
"""
Modified-MLP Inverse Training - Log File Version
...
print("="*80)
print("MODIFIED-MLP INVERSE TRAINING - LOG FILE METHOD")
print("="*80)
...
config.output.save_dir = 'results/modified_mlp_inverse_test'  # Custom output dir
print("✅ Config loaded")
...
print("\n[4.5/5] Creating output directory...")
Path(config.output.save_dir).mkdir(parents=True, exist_ok=True)
print(f"✅ Directory created: {config.output.save_dir}")
